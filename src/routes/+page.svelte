...
<center>
  ...
  <button class="bg-gray-600 hover:bg-gray-800 text-white font-bold py-2 px-4 mt-[100px] rounded-full w-[600px] h-[200px] text-6xl font-bold text-center" on:click={increment}>
    Start Game!
  </button>
</center>
